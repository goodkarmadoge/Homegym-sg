...
export const BUNDLE_COPY = {
  ...
  11: {
    ...
    pitch: "Smith, rack and cable in a single tower, with the bench and plates to load it from day one, and a leg press that bolts on when you want one. The same span of work as the biggest build here, at the price of a middling one.",
  ...
  16: {
    ...
    pitch: "Adjustable dumbbells from 4 to 23.5kg a side, and a bench that folds flat to 12cm. The whole thing lives under a bed between sessions.",
